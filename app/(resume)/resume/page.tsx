export default function Resume() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-screen-md flex-col gap-8 tracking-tight">
      ...
      {/* <h3 className="text-sm font-light uppercase">COURSES / CERTIFICATIONS</p>
      <div className="flex flex-col gap-4">
        {' '}
        <div className="flex flex-col gap-1">
          <div className="flex w-full justify-between">
            <h2 className="text-2xl font-bold">Learn JavaScript</h2>
            <p className="">04/2023</p>
          </div>
          <p className="font-normal">Codecademy</p>
        </div>
        <div className="flex flex-col">
          <div className="flex w-full justify-between">
            <h2 className="text-2xl font-bold">Learn React JS</h2>
            <p className="">04/2023</p>
          </div>
          <p className="font-normal">Scrimba</p>
        </div>
      </div> */}
